...
> {
    ...
    componentDidMount() {
        ...
        (async () => {
            const lastSavedGameState = await this.props.db.getLocalSaving(this.props.gameName)
                .catch(e => undefined);
            const noMusic = (await this.props.db.getConfigLocal("noMusic").catch(e => undefined)) || undefined;
            this.setState({ lastSavedGameState, gameInfoLoaded: true, noMusic });
    ...
    render() {
                                    ...
                                    <small>
                                        {(() => {
                                            ...
                                            if (
                                                ...
                                                typeof passedQuest !==
                                                    "object" ||
                                                Object.keys(passedQuest)
                                                    .length < 1
                                            ) {
                                                return;
                                            }
                                            // TODO: show when and how long
                            ...
                            <div className="row">                                                            
                                        <div className="col-md-6">
                                            <button
                                                ...
                                                onClick={async () => {
                                                    this.props.db.saveGame(this.props.gameName, null);
        ...
        loadInitialState={async () => {
            const saving = await this.props.db.getLocalSaving(this.props.gameName)
                .catch(e => undefined);
        ...
        onWin={winningProof => {
            this.props.db.setGamePassing(this.props.gameName, winningProof)
        }}
