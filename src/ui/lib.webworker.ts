/*
 Changed:
 1. Add // tslint:disable
 2. Remove /// <reference no-default-lib="true"/>
 3. Changed `...arguments: any[]` into `...args: any[]`
 4. add export into  ServiceWorkerGlobalScope
*/
