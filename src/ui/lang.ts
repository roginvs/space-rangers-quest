...
const RUS = {
    ...
    engineInstalledNeedReload: "Приложение установлено, необходимо закрыть и открыть страницу заново",
    engineUpdatedNeedReload: "Обновление установлено, необходимо закрыть и открыть страницу заново",
