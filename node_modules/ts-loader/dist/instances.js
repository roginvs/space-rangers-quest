...
function getTypeScriptInstance(loaderOptions, loader) {
    ...
    if (loaderOptions.transpileOnly) {
        ...
        return { instance: instances[loaderOptions.instance] = { compiler: compiler, compilerOptions: compilerOptions, loaderOptions: loaderOptions, files: files, dependencyGraph: {}, reverseDependencyGraph: {}, transformers: getCustomTransformers() } };
    }
