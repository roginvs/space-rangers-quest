 ...
 */
function areEquivalent(first, second, ignoreLiterals = false) {
...
function areEquivalentNodes(first, second, ignoreLiterals = false) {
    ...
    if (childCount === 0 && COMPARED_BY_TEXT.has(first.kind)) {
        if (ignoreLiterals && nodes_1.is(first, ts.SyntaxKind.StringLiteral, ts.SyntaxKind.NumericLiteral)) {
            return true;
        }
