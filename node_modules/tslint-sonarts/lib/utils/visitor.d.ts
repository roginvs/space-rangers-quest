...
export declare class TreeVisitor {
    ...
    protected visitDeleteExpression(node: ts.DeleteExpression): void;
    ...
    protected visitIntersectionTypeNode(node: ts.IntersectionTypeNode): void;
    ...
    protected visitNoSubstitionTemplateLiteral(node: ts.NoSubstitutionTemplateLiteral): void;
    ...
    protected visitParenthesizedExpression(node: ts.ParenthesizedExpression): void;
    ...
    protected visitUnionTypeNode(node: ts.UnionTypeNode): void;
    ...
    protected visitFunctionLikeDeclaration(node: ts.FunctionLikeDeclaration): void;
    protected visitNode(node: ts.Node): void;
    protected visitChildren(node: ts.Node): void;
}
